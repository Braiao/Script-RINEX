...
class CigalaRinex extends Cigala {
    ...
    public $sbf2rin_exe = "~/modelos-conversao/sbf2rin.exe"; //"/opt/Septentrio/RxTools/bin/sbf2rin";
    public $sbf2ismr_exe = "~/modelos-conversao/sbf2ismr.exe"; //"/opt/Septentrio/RxTools/bin/sbf2ismr";
    public $x;
    public $y;
    public $z;
