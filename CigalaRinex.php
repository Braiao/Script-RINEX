...
class CigalaRinex extends Cigala {
    ...
    public $rinex_path = '/script/Script-RINEX/tmp/'; // -- Pasta que o arquivo temporário foi criado
...
//ok 
    function getBinaryFile() {
        ...
        if (ftp_chdir($this->ftp_conn, "/RINEX3/" . $this->getName() . "/" . $this->getYear() . "/" . $this->getDay())) {
